...
Provides agent prompts and a factory function to create agents with
configurable models (cached per agent_type + model combination).
"""
import vertexai
import os
...
scoring_assist_agent = create_agent("scoring")
